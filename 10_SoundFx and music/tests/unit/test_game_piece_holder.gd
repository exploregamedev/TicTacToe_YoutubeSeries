...
func test_initialize_pieces_state_after_first_move_two_player_mode():
	...
	game_piece_holder.initialize(game_board)
	game_piece_holder.initialize_player_turn(just_played_piece_x, is_single_player_mode)
	...
	game_piece_holder.initialize_player_turn(just_played_piece_o, is_single_player_mode)
